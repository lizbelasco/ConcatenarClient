 ...
 */
@Configuration
public class ConcatenarConfiguration {
    ...
    @Bean
    public ConcatenarClient concatenarClient(Jaxb2Marshaller marshaller) {
        ConcatenarClient client = new ConcatenarClient();
        client.setDefaultUri("http://localhost:8080/concatenar");
